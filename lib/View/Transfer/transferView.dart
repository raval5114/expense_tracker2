...
class _TransferPageState extends State<TransferPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: const transferViewComponent());
  }
}

class transferViewComponent extends ConsumerStatefulWidget {
  const transferViewComponent({super.key});

  @override
  ConsumerState<transferViewComponent> createState() =>
      _transferViewComponentState();
}

class _transferViewComponentState extends ConsumerState<transferViewComponent> {
  String? _phoneNumber;
  ...
  final List<Contact> contacts = [
    Contact(name: 'Kashyap Raval', phoneNumber: '1234567890'),
